...
namespace Blockchain\Api\V2\Receive;
...
class Receive
{
     ...
     * @return \Blockchain\Api\V2\Receive\ReceiveResponse
     * @throws \Blockchain\Api\Exception\Error
     * @throws \Blockchain\Api\Exception\HttpError
     */
